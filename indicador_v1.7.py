...
return_frame = tk.LabelFrame(app, text="Resultados DB SCADA", padx=10, pady=5)
...
return_frame_utr = tk.LabelFrame(app, text="Resultados UTR", padx=10, pady=5)
...
l_cal_text_int.grid(row=0, column=0, sticky=(tk.W, tk.E))
l_cal_val_int.grid(row=0, column=1, sticky=(tk.W, tk.E))
...
def calcular():
    ...
    try:
        ...
        int16 = int ((corrente/20)*2**15-1) #trabalhar aqui
