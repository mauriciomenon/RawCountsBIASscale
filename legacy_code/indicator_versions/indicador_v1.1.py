...
l_amp_text = tk.Label(scale_frame, text="Valor (A)", anchor=tk.W)
l_amp_val = tk.Label(scale_frame, text="", anchor=tk.W)
l_amp_text.grid(row=3, column=0, sticky=(tk.W, tk.E))
l_amp_val.grid(row=3, column=1, sticky=(tk.W, tk.E))
